...
- Sau động từ "be" và trước "to + nhóm danh từ" cần điền 1 tính từ.
    - be + adj + to + noun
- ttsh + adj + N + N2 : danh từ càng đứng sau càng là danh từ chính trong câu
...
- since [+N(time)] `: từ lúc../từ khi..`
- like [+N/Ving] `:giống như là..`
- so [+adj/adv] `:quá..`
- fairly [+adj/adv] `:khá ..`
- Except for.. = apart from.. = exclude.. = Orther than.. [+N/Ving] `:ngoại trừ..`
- chú ý cấu trúc liên quan đến động từ "avoid" chính là: "avoid + V-ing" hoặc "avoid + danh từ"

# câu về từ loại
- give + sb + st `(v. có 2 tân ngữ): đưa cho ai cái gì`
...
- prescribe
- in appreciation for `nhằm thể hiện sự trân trọng`
